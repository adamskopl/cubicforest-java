...
public class RenderableObjectComparator implements Comparator<RenderableObject> {
	...
	@Override
	public int compare(final RenderableObject o1, final RenderableObject o2) {

		if (o1.getRenderType() != o2.getRenderType()) {
			Gdx.app.error("RenderableObjectComparator",
					"o1.getRenderType() != o2.getRenderType()");
			return 0;
		}

		switch (o1.getRenderType()) {
		case TYPE_WORLD:
			final WorldObject wo1 = (WorldObject) o1;
			final WorldObject wo2 = (WorldObject) o2;
			...
			final Vector2 wo1TP = wo1.getTilesPos();
			final Vector2 wo2TP = wo2.getTilesPos();
			if (wo1TP.x < wo2TP.x) {
				return -1;
			}
			if (wo1TP.x > wo2TP.x) {
